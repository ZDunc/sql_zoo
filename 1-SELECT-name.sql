...
This tutorial uses the LIKE operator to check names. We will be using the 
SELECT command on the table world.
*/

/* (1) You can use WHERE name LIKE 'B%' to find the countries that start 
with "B".
...
Find the countries that have two "o" characters separated by two 
others. */
...
The next questions are optional and only for students who are finding 
the basic questions too easy.

(11)
The capital of Luxembourg is Luxembourg. Show all the countries where 
