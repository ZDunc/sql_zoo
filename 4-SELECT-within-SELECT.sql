/* This tutorial looks at how we can use SELECT statements within 
SELECT statements to perform more complex queries.
...
containing either Argentina or Australia. Order by name of the 
country. */
...
/* (4) Which country has a population that is more than United Kingdom 
