/* This tutorial introduces the notion of a join. The database consists 
of three tables movie , actor and casting .
...
Use movieid=27, (or whatever value you got from the previous 
question) */
...
not in the starring role. [Note: the ord field of casting gives 
the position of the actor. If ord=1 then this actor is in the 
starring role] */
...
/* (10) List the films together with the leading star for all 1962 
films. */
