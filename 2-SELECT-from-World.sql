...
/* (2) How to use WHERE to filter records. Show the name for the countries 
...
(more than 3 million) or big by population (more than 250 million) but 
...
for the countries of the continent 'South America'. Use the ROUND function 
...
/* (10) Show the name and per-capita GDP for those countries with a GDP of 
at least one trillion (1000000000000; that is 12 zeros). Round this value to 
the nearest 1000.

Show per-capita GDP for the trillion dollar countries to the nearest $1000. */

SELECT name, ROUND((gdp/population), -3) AS gdp_pre_capita
  FROM world
...
The query shown misses countries like Bahamas and Belarus because they contain at 
least one 'a' */
