/* We continue practicing simple SQL queries on a 
single table.

This tutorial is concerned with a table of Nobel prize 
winners:

nobel(yr, subject, winner)
Using the SELECT statement. */

/* (1) Change the query shown so that it displays Nobel 
prizes for 1950. */
...
'Medicine' prize in an early year (before 1910, not including 
1910) together with winners of a 'Literature' prize in a later 
...
/* (14) The expression subject IN ('chemistry','physics') can be 
used as a value - it will be 0 or 1.
